...
var Battery = {
    ...
    attachListeners: function(_callBack) {
        mozBattery.addEventListener("chargingchange", Battery.updateBatteryStatus(_callBack));
        mozBattery.addEventListener("levelchange", Battery.updateBatteryStatus(_callBack));
    },
    ...
    updateBatteryStatus: function(_callBack) {
        ...
        _callBack({level: level, isPlugged: mozBattery.charging});
    }
};
